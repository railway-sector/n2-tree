...
}`)}function L(t){const e=t.projectionMatrix;return d(I,e[14],e[10])}const I=p();function J(t){t.fragment.uniforms.add(new T("projInfo",e=>R(e.camera))),t.fragment.uniforms.add(new v("zScale",e=>W(e.camera))),t.fragment.code.add(i`vec3 reconstructPosition(vec2 fragCoord, float depth) {
return vec3((fragCoord * projInfo.xy + projInfo.zw) * (zScale.x * depth + zScale.y), depth);
}`)}function R(t){const e=t.projectionMatrix;return e[11]===0?u(h,2/(t.fullWidth*e[0]),2/(t.fullHeight*e[5]),(1+e[12])/e[0],(1+e[13])/e[5]):u(h,-2/(t.fullWidth*e[0]),-2/(t.fullHeight*e[5]),(1-e[8])/e[0],(1-e[9])/e[5])}const h=x();function W(t){return t.projectionMatrix[11]===0?d(f,0,1):d(f,1,0)}const f=p();class Y extends m{constructor(e,r){super(e,"bool",0,(s,o)=>s.setUniform1b(e,r(o)))}}export{k as a,y as b,J as c,D as d,B as e,L as i,N as l,X as n,Y as r,A as t};
